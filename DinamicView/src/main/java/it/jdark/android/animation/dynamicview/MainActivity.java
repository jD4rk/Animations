...
//                new Sample(R.string.title_crossfade, CrossfadeActivity.class),
                new Sample(R.string.title_activity_standard, ListViewElementAnimationStandard.class),
                new Sample(R.string.title_activity_custom, ListViewElementAnimationCustom.class),
                new Sample(R.string.title_activity_multi_animation_layout, MultiAnimationLayout.class)
        };
