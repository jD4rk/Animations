package it.jdark.android.animation.complexanimation;
...
public class MainWithAnimatorActivity extends Activity {
	...
	private void startAnimation() {
		new Handler().postDelayed(new Runnable() {
			@Override
			public void run() {
				animator.setAnimatorViews(mMainContainer, mTv2, mFirstGroup,
						Arrays.asList(new View[]{mSecondGroup, mSecondSpacer}),
						mFirstSpacer, mEditModeContainer, Arrays.asList(new View[]{}));
